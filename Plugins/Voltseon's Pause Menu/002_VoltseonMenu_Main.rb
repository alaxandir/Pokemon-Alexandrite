...
DebugMenuCommands.register("setmenutheme", {
  ...
  "description" => _INTL("Change the Menu Theme for Voltseon's Pog Menu..."),
  "effect"      => proc {
		maxval = 0
		loop do
    ...
    $PokemonSystem.current_menu_theme = pbMessageChooseNumber(_INTL("Set the menu theme. (0 - #{maxval})"), params)
